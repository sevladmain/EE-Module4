        ...
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="/orderId/add">Створити</a></li>
                        <li><a href="/orderId/allOpen">Вивести відкриті замовлення</a></li>
                        <li><a href="/orderId/allClosed">Вивести закриті замовлення</a></li>
                    </ul>
                </li>
                <li class="dropdown">

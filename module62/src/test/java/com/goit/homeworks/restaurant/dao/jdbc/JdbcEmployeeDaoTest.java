...
public class JdbcEmployeeDaoTest {
    ...
    public  void getAllEmployeesTest(){
        ...
        Employee employee = new Employee(1, "Mary", "Ivanova", Date.valueOf("1998-08-12"), 2, 1000);
        ...
        assertThat(testedEmployee.getPositionId(), equalTo(employee.getPositionId()));
        assertThat(testedEmployee.getDateBirth(), equalTo(employee.getDateBirth()));
    }
    @Test
    public void createNewEmployee(){
        Employee testEmployee = new Employee("Seriy","Suchok", Date.valueOf("1996-12-05"), 1, 10000);
        ...
        assertThat((Integer) rows.get(0).get("ID_POSITION"), equalTo(testEmployee.getPositionId()));
    ...
    public void createEmployeeWithExistingID(){
        Employee employee = dao.create(new Employee(1, "Seriy","Suchok", Date.valueOf("1996-12-05"), 1, 10000));
//        List<Map<String, Object>> rows = jdbcTemplate.queryForList(SQL_SELECT_STATEMENT);
    ...
    public void removeFakeEmployee(){
        Employee fakeEmployee = new Employee(5, "Seriy","Suchok", Date.valueOf("1996-12-05"), 1, 10000);
    ...
    public void testFindEmployeeByID(){
        ...
        Employee trueEmployee = new Employee(1, "Mary", "Ivanova", Date.valueOf("1998-08-12"), 2, 1000);
        assertThat(employee, equalTo(trueEmployee));
    }

    @Test
    public void testUpdateEmployee(){
        Employee testEmployee = new Employee(1, "Sergiy", "Ivanov", Date.valueOf("2008-07-01"), 3, 2000);
    ...
    public void testUpdateFakeEmployee(){
        Employee fakeEmployee = new Employee(2, "Mary", "Ivanova", Date.valueOf("1998-08-12"), 2, 1000);
